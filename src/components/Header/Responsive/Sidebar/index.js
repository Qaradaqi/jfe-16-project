      ...
      <div className="full-container">
        <div ref={sidebar} className="sidebar-content">
          ...
          <div className="sidebar-items flex flex-column nowrap">
            <div onClick={onClickOutside} className="item logo flex align-center">
            ...
            <div onClick={onClickOutside} className="item flex align-center gap-5">
            ...
            <div className="item flex align-center justify-end gap-5">
              <div onClick={onClickOutside} className="btn-account flex align-center">
                <Button type={'primary'} size={'medium'}>Create Account</Button>
              </div>
              <div onClick={onClickOutside} className="flex align-center">
